...
export const t = {
  ...
  hero: {
    ...
    desc:  { mn: "«Хүжиртын хөх сувд» халуун рашаан, «Хужиртын хар сувд» эмчилгээний шавраар байгалийн аргаар эрүүлж, сэргэн хүч авна уу.", en: "Restore yourself through the world-renowned «Blue Pearl» hot springs and «Black Pearl» therapeutic mud of Khujirt." },
